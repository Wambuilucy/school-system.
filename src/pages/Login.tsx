...
const roles: { value: SignupRole; label: string; icon: typeof GraduationCap; desc: string; color: string }[] = [
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {isSignup && (
          <p className="text-center text-xs text-muted-foreground">
            Admin accounts cannot be created here — they must be assigned by an existing admin.
          </p>
        )}
      </div>
    </div>
